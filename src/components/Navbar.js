...
function Navbar() {
  return (
    <div  className=" h-16 lg:border-[1px] border-2 flex font-[Open Sans] px-6 border-[#D3D3D3] justify-between items-center">
      <img onClick={openDrawer}  alt="" src={menuBarIcon} id="menuIcon" className="w-7 lg:hidden h-7" ></img>
      <img onClick={closeDrawer} id="backIcon"  alt='' className='h-6 hidden lg:hidden w-6' src={leftArrow}></img>
      <div className="font-bold hidden lg:flex text-lg text-[#262626]">Logo</div>
